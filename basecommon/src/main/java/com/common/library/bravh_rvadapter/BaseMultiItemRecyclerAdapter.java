 ...
 */
public abstract class BaseMultiItemRecyclerAdapter<T extends MultiItemEntity, K extends RecyclerViewHolder> extends BaseRecyclerAdapter<T, K> {
     ...
     */
    public BaseMultiItemRecyclerAdapter(List<T> data) {
        super(data);
    }
