package com.common.library.bravh_rvadapter.callback;
...
import com.common.R;
import com.common.library.bravh_rvadapter.BaseItemDraggableAdapter;
...
public class ItemDragAndSwipeCallback extends ItemTouchHelper.Callback {
    ...
    private boolean isViewCreateByAdapter(@NonNull RecyclerView.ViewHolder viewHolder) {
        ...
        return type == BaseRecyclerAdapter.HEADER_VIEW || type == BaseRecyclerAdapter.LOADING_VIEW
                || type == BaseRecyclerAdapter.FOOTER_VIEW || type == BaseRecyclerAdapter.EMPTY_VIEW;
    }
}
