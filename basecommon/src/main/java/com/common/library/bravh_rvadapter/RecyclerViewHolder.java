...
public class RecyclerViewHolder extends RecyclerView.ViewHolder {
     ...
     */
    public RecyclerViewHolder setText(@IdRes int viewId, CharSequence value) {
     ...
     * Alpha between 0-1.
     */
    public RecyclerViewHolder setAlpha(@IdRes int viewId, float value) {
     ...
     */
    public RecyclerViewHolder setTypeface(@IdRes int viewId, Typeface typeface) {
        TextView view = getView(viewId);
    ...
    public RecyclerViewHolder addOnClickListener(@IdRes final int... viewIds) {
        for (int viewId : viewIds) {
     ...
     * @return
     */
    public RecyclerViewHolder setNestView(@IdRes int... viewIds) {
        for (int viewId : viewIds) {
     ...
     */
    @SuppressWarnings("unchecked")
    public RecyclerViewHolder addOnLongClickListener(@IdRes final int... viewIds) {
        for (int viewId : viewIds) {
     ...
     */
    @Deprecated
    public RecyclerViewHolder setOnItemClickListener(@IdRes int viewId, AdapterView.OnItemClickListener listener) {
     ...
     * @return The RecyclerViewHolder for chaining.
     */
    public RecyclerViewHolder setOnItemLongClickListener(@IdRes int viewId, AdapterView.OnItemLongClickListener listener) {
        AdapterView view = getView(viewId);
     ...
     * @return The RecyclerViewHolder for chaining.
     */
    public RecyclerViewHolder setOnItemSelectedClickListener(@IdRes int viewId, AdapterView.OnItemSelectedListener listener) {
        AdapterView view = getView(viewId);
     ...
     * @return The RecyclerViewHolder for chaining.
     */
    public RecyclerViewHolder setOnCheckedChangeListener(@IdRes int viewId, CompoundButton.OnCheckedChangeListener listener) {
     ...
     * @return The RecyclerViewHolder for chaining.
     */
    public RecyclerViewHolder setEnabled(@IdRes int viewId, boolean enable) {
        View view = getView(viewId);
     ...
     */
    @SuppressWarnings("unchecked")
    public RecyclerViewHolder setAdapter(@IdRes int viewId, Adapter adapter) {
        AdapterView view = getView(viewId);
     ...
     * @return The RecyclerViewHolder for chaining.
     */
    protected RecyclerViewHolder setAdapter(BaseRecyclerAdapter adapter) {
