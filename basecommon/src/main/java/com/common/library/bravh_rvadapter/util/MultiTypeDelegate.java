package com.common.library.bravh_rvadapter.util;
...
import static com.common.library.bravh_rvadapter.BaseMultiItemRecyclerAdapter.TYPE_NOT_FOUND;
...
public abstract class MultiTypeDelegate<T> {
     ...
     *
     * @param layoutResIds layout_game_detail_outs_more_image_progress_bar id arrays
     ...
     * @param layoutResId layout_game_detail_outs_more_image_progress_bar id
     * @return MultiTypeDelegate
     */
