package com.common.library.bravh_rvadapter.provider;
...
public abstract class BaseItemProvider<T,V extends RecyclerViewHolder> {
    ...
    //子类须重写该方法返回layout
    //Rewrite this method to return layout_game_detail_outs_more_image_progress_bar
