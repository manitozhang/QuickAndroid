...
import com.common.library.bravh_rvadapter.entity.SectionMultiEntity;
 ...
 */
public abstract class BaseSectionMultiItemRecyclerAdapter<T extends SectionMultiEntity, K extends RecyclerViewHolder> extends BaseRecyclerAdapter<T, K> {
     ...
     */
    public BaseSectionMultiItemRecyclerAdapter(int sectionHeadResId, List<T> data) {
        super(data);
    ...
    /**
     * collect layout_game_detail_outs_more_image_progress_bar types you need
     *
     * @param type             The key of layout_game_detail_outs_more_image_progress_bar type
     * @param layoutResId      The layoutResId of layout_game_detail_outs_more_image_progress_bar type
     */
