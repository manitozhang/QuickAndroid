...
import com.common.library.autosize.external.ExternalAdaptManager;
import com.common.library.autosize.unit.UnitsManager;
import com.common.library.autosize.utils.Preconditions;
import com.common.library.autosize.utils.ScreenUtils;
...
public final class AutoSizeConfig {
    ...
    AutoSizeConfig init(final Application application, boolean isBaseOnWidth, AutoAdaptStrategy strategy) {
        ...
        Log.d(TAG,"designWidthInDp = " + mDesignWidthInDp + ", designHeightInDp = " + mDesignHeightInDp + ", screenWidth = " + mScreenWidth + ", screenHeight = " + mScreenHeight);
            ...
            public void onConfigurationChanged(Configuration newConfig) {
                if (newConfig != null) {
                    if (newConfig.fontScale > 0) {
                        ...
                        Log.d(TAG,"initScaledDensity = " + mInitScaledDensity + " on ConfigurationChanged");
                    }
        ...
        Log.d(TAG,"initDensity = " + mInitDensity + ", initScaledDensity = " + mInitScaledDensity);
