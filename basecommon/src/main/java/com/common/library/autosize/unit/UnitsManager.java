 ...
 */
package com.common.library.autosize.unit;
 ...
 * 您选择什么单位, 就在 layout_game_detail_outs_more_image_progress_bar 文件中用什么单位布局
 * <p>
 ...
 * 然后在 layout_game_detail_outs_more_image_progress_bar 文件中只使用这个副单位进行布局, 这样就可以完全规避修改 {@link DisplayMetrics#density} 所造成的问题
